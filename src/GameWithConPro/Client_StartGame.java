...
public class Client_StartGame extends javax.swing.JFrame {
    ...
    BufferedReader br;
    public static String ClientInput = "", name = "";
    public static boolean loop = true;
    private static boolean started = false;
    public static boolean sendName = false;
    ...
    private void start_end_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_start_end_buttonMouseClicked
        ...
        if (flag) {
            ...
            try {
                ...
                System.out.println("Just Connected to " + Clientsocket.getInetAddress());
                msg_area.append("Just Connected to " + Clientsocket.getInetAddress() + "\n\n******************************\n\n");
            ...
            if (isInteger(ClientInput) || sendName == true) {
                if (started) {
                    ...
                    if (sendName == false) {
                        ...
                        System.out.println("User Name : " + gusInput);
                    }
    ...
    public static void RcvrTh() {
        ReceiverThread rcv = new ReceiverThread(Clientsocket);
        Thread tr = new Thread(rcv);
        tr.start();
    }
    ...
    public static javax.swing.JButton score_button;
    public static javax.swing.JLabel score_show;
    public static javax.swing.JToggleButton start_end_button;
